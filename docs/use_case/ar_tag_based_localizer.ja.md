...
[サンプル](https://github.com/tier4/driving_log_replayer_v2/blob/main/sample/ar_tag_based_localizer/scenario.yaml)参照

### 評価結果フォーマット

[サンプル](https://github.com/tier4/driving_log_replayer_v2/blob/main/sample/ar_tag_based_localizer/result.json)参照
