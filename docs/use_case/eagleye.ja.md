...
[サンプル](https://github.com/tier4/log_evaluator/blob/main/sample/eagleye/scenario.yaml)参照

### 評価結果フォーマット

[サンプル](https://github.com/tier4/log_evaluator/blob/main/sample/eagleye/result.json)参照
