...
[サンプル](https://github.com/tier4/driving_log_replayer_v2/blob/develop/sample/performance_diag/scenario.ja.yaml)参照

### 評価結果フォーマット

[サンプル](https://github.com/tier4/driving_log_replayer_v2/blob/develop/sample/performance_diag/result.json)参照
