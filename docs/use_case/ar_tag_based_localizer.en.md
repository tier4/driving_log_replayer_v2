...
See [sample](https://github.com/tier4/driving_log_replayer_v2/blob/main/sample/ar_tag_based_localizer/scenario.yaml).

### Evaluation Result Format

See [sample](https://github.com/tier4/driving_log_replayer_v2/blob/main/sample/ar_tag_based_localizer/result.json).
