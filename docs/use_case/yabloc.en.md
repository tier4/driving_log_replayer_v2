...
See [sample](https://github.com/tier4/driving_log_replayer_v2/blob/main/sample/yabloc/scenario.yaml).

### Evaluation Result Format

See [sample](https://github.com/tier4/driving_log_replayer_v2/blob/main/sample/yabloc/result.json).
