...
[サンプル](https://github.com/tier4/driving_log_replayer_v2/blob/main/sample/traffic_light/scenario.ja.yaml)参照

### 評価結果フォーマット

[サンプル](https://github.com/tier4/driving_log_replayer_v2/blob/main/sample/traffic_light/result.json)参照
