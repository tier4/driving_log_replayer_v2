...
def launch_bag_player(
    ...
    # Run pre-task first, then wait play_delay seconds, then fixed 10 seconds before starting rosbag play.
    delay_player_for_bag = ExecuteProcess(cmd=["sleep", "10"], on_exit=[bag_player])
